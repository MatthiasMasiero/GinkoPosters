...
-- Products for Laz Lewis
INSERT INTO products (id, artist_id, title, slug, description, image_url, is_active) VALUES
  ('b4000001-0000-0000-0000-000000000001', 'a4444444-4444-4444-4444-444444444444', 'Starfish', 'starfish', 'A sunlit moment on the rocks — snorkel mask up, starfish in hand. Mediterranean blues and warm skin tones frame a slow coastal afternoon.', '/images/laz-lewis/starfish.jpg', true);
...
INSERT INTO product_variants (id, product_id, size, sku, price, cost_price) VALUES
  ...
  -- Laz Lewis — Starfish
  (uuid_generate_v4(), 'b4000001-0000-0000-0000-000000000001', 'A4', 'LLW-STF-A4', 24.99, 6.00),
  (uuid_generate_v4(), 'b4000001-0000-0000-0000-000000000001', 'A3', 'LLW-STF-A3', 34.99, 9.00),
  (uuid_generate_v4(), 'b4000001-0000-0000-0000-000000000001', 'A2', 'LLW-STF-A2', 49.99, 14.00);
